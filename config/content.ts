 ...
 * 
 * IMPORTANT: The APK file should be placed in the public folder as gymflow.apk
 * and will be downloadable from /gymflow.apk
 * 
...
export const content: LandingPageContent = {
  hero: {
    ...
    primaryCTA: {
      ...
      url: '/gymflow.apk', // Direct APK download link
    },
    secondaryCTA: {
  ...
  finalCTA: {
    ...
    ctaUrl: '/gymflow.apk', // Direct APK download link
